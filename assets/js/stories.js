...
(function () {
  ...
  var STORY_TRACKS = [
    [
      ...
      { name: 'Owen G.',     product: 'Pacagen', location: 'San Diego, CA',     color: '#023a90', story: 'I moved in with my partner knowing she had two cats. I genuinely thought we\'d have to rehome them. Pacagen saved our relationship — and saved the cats. Three months in I stopped reacting entirely.' },
    ...
    [
      ...
      { name: 'Derek W.',    product: 'Pacagen', location: 'Kansas City, MO',   color: '#031e58', story: 'My wife has three cats. My allergies meant I slept in a separate room. That is not a sustainable living arrangement. Pacagen fixed that. I wake up in the same bed as my wife now. Sounds minor. It\'s not.' },
